...
exports.accountPut = function(req, res, next) {
  ...
  User.findById(req.user.id, function(err, user) {
    if ('password' in req.body) {
      ...
      user.studying = req.body.studying;
      user.interest = req.body.interest;
      user.geo = [req.body.Latitude,req.body.Longitude];
...
exports.forgotPost = function(req, res, next) {
  ...
  async.waterfall([
    ...
    function(token, user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'NearU@nearu.com',
        subject: '✔ Reset your password on NearU',
  ...
  async.waterfall([
    ...
    function(user, done) {
      ...
      var mailOptions = {
        from: 'nearU@neau.com',
        to: user.email,
        subject: 'Your  NearU password has been changed',
        text: 'Hello,\n\n' +
...
exports.pingrequest = function(req, res) {
  res.render('users/pingrequest', {
    title: 'Request'
  });
};
